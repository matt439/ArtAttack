...
namespace player_consts
{
    ...
    constexpr player_team DEFAULT_TEAM = player_team::A;
    const MattMath::Colour DEFAULT_TEAM_COLOUR = colour_consts::GRAY;
    constexpr wep_type DEFAULT_PRIMARY = wep_type::SPRAYER;
    constexpr wep_type DEFAULT_SECONDARY = wep_type::GRENADE_STD;

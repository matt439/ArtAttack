...
//void ProjectileJet::draw(const Camera& camera)
//{
//	float rotation = this->MovingObject::get_velocity_angle();
//	this->AnimationObject::set_draw_rotation(rotation);
//
//	//Vector2F origin = Vector2F(-this->get_details().col_rect_size.x / 2.0f,
//	//	-this->get_details().col_rect_size.y / 2.0f);
//	//this->AnimationObject::set_origin(origin);
...
//	return &this->_rectangle;
//}
////float ProjectileJet::calculate_rotation() const
////{
////
////}
//RectangleF ProjectileJet::get_draw_rectangle() const
//{
